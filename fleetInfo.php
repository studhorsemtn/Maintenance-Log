...
<body>
    ...
    if (isset($_POST['Submit'])) {
        ...
        $sql = "INSERT INTO fleet_info (equipment, year_made, make, model, hyd_oil_type, hyd_oil_cap, vin, belt1,
        ...
        tag2_up, tag2_down, drive_axle) VALUES ('$equipment', '$year_made', '$make', '$model', '$hyd_oil_type', '$hyd_oil_cap', '$vin', '$belt1', 
        '$belt2', '$eng_make', '$eng_model', '$eng_serial', '$eng_arrangement', '$eng_oil_cap', '$eng_oil_type', '$eng_misc1', '$eng_misc2', '$eng_oil_filter1',
        '$eng_oil_filter2', '$coolant_filter', '$trans_filter', '$hyd_filter1', '$hyd_filter2', '$power_steering_filter', '$fuel_filter1', '$fuel_filter2', 
        '$cab_filter1', '$cab_filter2', '$air_filter1', '$air_filter2', '$trans_make', '$trans_model', '$trans_serial', '$trans_oil_cap', '$trans_oil_type',
        '$steer_make', '$steer_model', '$steer_ratio', '$steer_oil_type1', '$steer_oil_cap1', '$steer_oil_type2', '$steer_oil_cap2', '$drive_make',
        '$drive_model', '$drive_ratio', '$drive_oil1', '$drive_oil_cap1', '$drive_oil2', '$drive_oil_cap2', '$steer_size', '$pusher1_size', 
        '$pusher2_size', '$drive_size', '$tag1_size', '$tag2_size', '$pusher1_up', '$pusher1_down', '$pusher2_up', '$pusher2_down', '$tag1_up', 
        '$tag1_down', '$tag2_up', '$tag2_down', '$drive_axle')";
